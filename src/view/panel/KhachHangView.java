...
public class KhachHangView extends javax.swing.JPanel {
    ...
    public KhachHangView() {
        initComponents();
        ArrayList<KhachHang> listDS = qlkh.getList();
        loadData(listDS);
    }
    ...
    private void initComponents() {
        ...
        bGroupTT = new javax.swing.ButtonGroup();
    ...
    private void txtTimKiemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtTimKiemMouseClicked
        try {
            ...
            String cccd = txtTimKiem.getText();
            ArrayList<KhachHang> listKQ = qlkh.searchKH(qlkh.getList(), ma, ten, sdt, email, cccd);
...
//       
    ...
    private javax.swing.ButtonGroup bGroupTT;
